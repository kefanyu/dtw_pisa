...
```{r}
reading_clust_opt <- tsclust(reading_lst, type = "partitional", k = 3, distance = "dtw", centroid = "pam",seed = 725)
...
```{r}
reading_clust_opt_eu <- tsclust(reading_lst, type = "partitional", k = 3, distance = "Euclidean", centroid = "pam",seed = 725)
```
...
write_xlsx(list("DTW" = reading_dtw_df, "Euclidean" = reading_eu_df),"../../data/dtw/reading_oecd_gap_distance.xlsx")
```
...
```{r}
write_xlsx(list("DTW" = math_dtw_df, "Euclidean" = math_eu_df),"../../data/dtw/math_oecd_gap_distance.xlsx")
```
...
```{r}
write_xlsx(list("DTW" = sci_dtw_df, "Euclidean" = sci_eu_df),"../../data/dtw/sci_oecd_gap_distance.xlsx")
```