...
```{r}
reading <- read_excel("../../data/oecd/oecd_gender_2022_int.xlsx", sheet = "Reading")
math <- read_excel("../../data/oecd/oecd_gender_2022_int.xlsx", sheet = "Math")
sci <- read_excel("../../data/oecd/oecd_gender_2022_int.xlsx", sheet = "Science")
```
...
result_reading_avg = cbind(reading$Country, cluster = reading_clust_opt@cluster)
...
result_reading_avg2 = cbind(reading$Country, cluster = reading_clust_opt2@cluster)
...
result_reading_avg3 = cbind(reading$Country, cluster = reading_clust_opt3@cluster)
...
result_reading_avg4 = cbind(reading$Country, cluster = reading_clust_opt4@cluster)
...
result_reading_avg5 = cbind(reading$Country, cluster = reading_clust_opt5@cluster)
...
result_reading_avg_h <- as.data.frame(cbind(reading$Country, cluster = reading_clust_opt_h@cluster))
...
result_math_avg = cbind(reading$Country, cluster = math_clust_opt@cluster)
...
result_math_avg2 = cbind(reading$Country, cluster = math_clust_opt2@cluster)
...
result_math_avg3 = cbind(reading$Country, cluster = math_clust_opt3@cluster)
...
result_math_avg4 = cbind(reading$Country, cluster = math_clust_opt4@cluster)
...
result_math_avg5 = cbind(reading$Country, cluster = math_clust_opt5@cluster)
...
```{r}
result_math_avg_h = cbind(reading$Country, cluster = math_clust_opt_h@cluster)
...
result_sci_avg = cbind(reading$Country, cluster = sci_clust_opt@cluster)
...
```{r}
print(t(cbind(reading$Country, cluster = sci_clust_opt_h@cluster)))
```