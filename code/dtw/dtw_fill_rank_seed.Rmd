...
cat("Countries in K5: ", result_math_avg$V1[result_math_avg$cluster == "5"], "\n")
cat("Countries in K6: ", result_math_avg$V1[result_math_avg$cluster == "6"], "\n")
```
...
cat("Countries in K5: ", result_math_avg2$V1[result_math_avg2$cluster == "5"], "\n")
cat("Countries in K6: ", result_math_avg2$V1[result_math_avg2$cluster == "6"], "\n")
```
...
cat("Countries in K5: ", result_math_avg3$V1[result_math_avg3$cluster == "5"], "\n")
cat("Countries in K6: ", result_math_avg3$V1[result_math_avg3$cluster == "6"], "\n")
```
...
cat("Countries in K5: ", result_math_avg4$V1[result_math_avg4$cluster == "5"], "\n")
cat("Countries in K6: ", result_math_avg4$V1[result_math_avg4$cluster == "6"], "\n")
```
...
cat("Countries in K5: ", result_math_avg5$V1[result_math_avg5$cluster == "5"], "\n")
cat("Countries in K6: ", result_math_avg5$V1[result_math_avg5$cluster == "6"], "\n")
```
