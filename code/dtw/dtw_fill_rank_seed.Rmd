...
cat("Number of countries in K5: ", nrow(result_math_avg[result_math_avg['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg[result_math_avg['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt2 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 726)
...
cat("Number of countries in K4: ", nrow(result_math_avg2[result_math_avg2['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg2[result_math_avg2['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg2[result_math_avg2['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt3 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 727)
...
cat("Number of countries in K4: ", nrow(result_math_avg3[result_math_avg3['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg3[result_math_avg3['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg3[result_math_avg3['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt4 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 728)
...
cat("Number of countries in K4: ", nrow(result_math_avg4[result_math_avg4['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg4[result_math_avg4['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg4[result_math_avg4['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt5 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 729)
...
cat("Number of countries in K4: ", nrow(result_math_avg5[result_math_avg5['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg5[result_math_avg5['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg5[result_math_avg5['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt6 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 730)
...
cat("Number of countries in K4: ", nrow(result_math_avg6[result_math_avg6['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg6[result_math_avg6['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg6[result_math_avg6['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt7 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 731)
...
cat("Number of countries in K4: ", nrow(result_math_avg7[result_math_avg7['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg7[result_math_avg7['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg7[result_math_avg7['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt8 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 732)
...
cat("Number of countries in K4: ", nrow(result_math_avg8[result_math_avg8['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg8[result_math_avg8['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg8[result_math_avg8['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt9 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 7332)
...
cat("Number of countries in K4: ", nrow(result_math_avg9[result_math_avg9['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg9[result_math_avg9['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg9[result_math_avg9['cluster'] == "6", ]), "\n")
```

```{r}
math_clust_opt10 <- tsclust(math_lst, type = "partitional", k = 6, distance = "dtw", centroid = "pam",seed = 734)

result_math_avg10 = cbind(reading$Countries, cluster = math_clust_opt10@cluster)
result_math_avg10 <- as.data.frame(result_math_avg10)

cat("Number of countries in K1: ", nrow(result_math_avg10[result_math_avg10['cluster'] == "1", ]), "\n")
cat("Number of countries in K2: ", nrow(result_math_avg10[result_math_avg10['cluster'] == "2", ]), "\n")
cat("Number of countries in K3: ", nrow(result_math_avg10[result_math_avg10['cluster'] == "3", ]), "\n")
cat("Number of countries in K4: ", nrow(result_math_avg10[result_math_avg10['cluster'] == "4", ]), "\n")
cat("Number of countries in K5: ", nrow(result_math_avg10[result_math_avg10['cluster'] == "5", ]), "\n")
cat("Number of countries in K6: ", nrow(result_math_avg10[result_math_avg10['cluster'] == "6", ]), "\n")
```
...
cat("Number of countries in K4: ", nrow(result_sci_avg2[result_sci_avg2['cluster'] == "4", ]), "\n")
```
...
cat("Number of countries in K4: ", nrow(result_sci_avg3[result_sci_avg3['cluster'] == "4", ]), "\n")
```
...
cat("Number of countries in K4: ", nrow(result_sci_avg4[result_sci_avg4['cluster'] == "4", ]), "\n")
```
...
cat("Number of countries in K4: ", nrow(result_sci_avg5[result_sci_avg5['cluster'] == "4", ]), "\n")
```
...
cat("Number of countries in K1: ", nrow(result_sci_avg6[result_sci_avg6['cluster'] == "1", ]), "\n")
cat("Number of countries in K2: ", nrow(result_sci_avg6[result_sci_avg6['cluster'] == "2", ]), "\n")
cat("Number of countries in K3: ", nrow(result_sci_avg6[result_sci_avg6['cluster'] == "3", ]), "\n")
cat("Number of countries in K4: ", nrow(result_sci_avg6[result_sci_avg6['cluster'] == "4", ]), "\n")
```
...
cat("Number of countries in K1: ", nrow(result_sci_avg7[result_sci_avg7['cluster'] == "1", ]), "\n")
cat("Number of countries in K2: ", nrow(result_sci_avg7[result_sci_avg7['cluster'] == "2", ]), "\n")
cat("Number of countries in K3: ", nrow(result_sci_avg7[result_sci_avg7['cluster'] == "3", ]), "\n")
cat("Number of countries in K4: ", nrow(result_sci_avg7[result_sci_avg7['cluster'] == "4", ]), "\n")
```
...
```{r}
print(t(cbind(reading$Countries, cluster = sci_clust_opt@cluster)))
```

```{r}
print(t(cbind(reading$Countries, cluster = sci_clust_opt7@cluster)))
```