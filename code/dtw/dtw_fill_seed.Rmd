...
cat("Number of countries in K1: ", nrow(result_sci_avg8[result_sci_avg8['cluster'] == "1", ]), "\n")
cat("Number of countries in K2: ", nrow(result_sci_avg8[result_sci_avg8['cluster'] == "2", ]), "\n")
cat("Number of countries in K3: ", nrow(result_sci_avg8[result_sci_avg8['cluster'] == "3", ]), "\n")
cat("Number of countries in K4: ", nrow(result_sci_avg8[result_sci_avg8['cluster'] == "4", ]), "\n")
```
...
cat("Number of countries in K1: ", nrow(result_sci_avg9[result_sci_avg9['cluster'] == "1", ]), "\n")
cat("Number of countries in K2: ", nrow(result_sci_avg9[result_sci_avg9['cluster'] == "2", ]), "\n")
cat("Number of countries in K3: ", nrow(result_sci_avg9[result_sci_avg9['cluster'] == "3", ]), "\n")
cat("Number of countries in K4: ", nrow(result_sci_avg9[result_sci_avg9['cluster'] == "4", ]), "\n")
```
...
cat("Number of countries in K1: ", nrow(result_sci_avg10[result_sci_avg10['cluster'] == "1", ]), "\n")
cat("Number of countries in K2: ", nrow(result_sci_avg10[result_sci_avg10['cluster'] == "2", ]), "\n")
cat("Number of countries in K3: ", nrow(result_sci_avg10[result_sci_avg10['cluster'] == "3", ]), "\n")
cat("Number of countries in K4: ", nrow(result_sci_avg10[result_sci_avg10['cluster'] == "4", ]), "\n")
```
